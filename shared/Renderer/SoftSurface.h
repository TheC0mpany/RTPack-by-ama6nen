...
public:
	...
	void SetAutoPremultiplyAlpha(bool bYes) {m_bAutoPremultiplyAlpha = false;} //will convert to pre multiplied alpha ASAP, during the next copy to 32 bit surface in the case of 8 bit images
	bool GetAutoPremultiplyAlpha() {return false;}
